...
class qcraft_check(BaseHTTPRequestHandler):
    ...
    def handle_root(self):
        ...
        <html>
            <head>
                <title>Q-%s设备监控服务-Version:ND_2.0</title>
                <meta charset="UTF-8">
                <style>
            ...
            <body>
                <h1>Q-%s设备监控服务--Version:ND_2.0s</h1>
                <p>版本：1.0</p>
                ...
                <div class="endpoint">
                    <h3>单项检查</h3>
                    <ul>
                        <li><a href="/orin">Orin检查</a> - /orin</li>
                        <li><a href="/Host">Host检查</a> - /Host</li>
                        <li><a href="/lidar_check">lidar检查</a> - /lidar</li>
                        <li><a href="/network">网络检查</a> - /network</li>
                        <li><a href="/version">版本检查</a> - /version</li>
                        <li><a href="/mount">挂载检查</a> - /mount</li>
                        <li><a href="/disk">磁盘检查</a> - /disk</li>
                        <li><a href="/beiyun">北云检查</a> - /beiyun</li>
                        <li><a href="/process">进程检查</a> - /process</li>
                        <li><a href="/isp">isp版本检查</a> - /isp</li>
                        <li><a href="/Reboot_Orin_Y">重启域控</a> - /Reboot_Orin_Y</li>
    ...
    def reboot_cmd(self):
        try:
            reboot_status = main_host.Reboot_orin()
            if reboot_status[0] == 0:
                return reboot_status[1]
            else:
                return reboot_status[1]
        except Exception as e:
            return {"status": "error", "message": f"重启域控节点异常: {str(e)}"}
    ...
    def check_lidar(self):
        try:
            lidar_list = main_host.status_lidars()
